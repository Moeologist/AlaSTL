...
protected:
    ...
    template<class NodePtr,
             class NAlloc = typename multiset::allocator_type::template rebind<
                 typename pointer_traits<NodePtr>::element_type>::other>
    struct _node_adaptor {
        typedef multiset::value_type multisetped_type;
        typedef multiset::allocator_type allocator_type;
    ...
    private:
        friend class multiset<key_type, key_compare, allocator_type>;
...
public:
    ...
    const_iterator cbegin() const noexcept {
        return const_iterator(const_cast<multiset *>(this)->begin());
    }

    const_iterator cend() const noexcept {
        return const_iterator(const_cast<multiset *>(this)->end());
    }

    const_reverse_iterator crbegin() const noexcept {
        return const_iterator(const_cast<multiset *>(this)->rbegin());
    }

    const_reverse_iterator crend() const noexcept {
        return const_iterator(const_cast<multiset *>(this)->rend());
    }
    ...
    const_iterator find(const key_type &k) const {
        return const_cast<multiset *>(this)->find(k);
    }
    ...
    const_iterator lower_bound(const key_type &k) const {
        return const_cast<multiset *>(this)->lower_bound(k);
    }
    ...
    const_iterator upper_bound(const key_type &k) const {
        return const_cast<multiset *>(this)->upper_bound(k);
    }
