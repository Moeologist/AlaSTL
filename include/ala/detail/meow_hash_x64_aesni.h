...
#define prefetcht0(A) _mm_prefetch((const char *)(A), _MM_HINT_T0)
#define movdqu(A, B)  A = _mm_loadu_si128((const __m128i *)(B))
...
MeowHash(const void *Seed128Init, meow_umm Len, const void *SourceInit)
{
    ...
    const meow_u8 *rax = (const meow_u8 *)SourceInit;
    const meow_u8 *rcx = (const meow_u8 *)Seed128Init;
