...
template <typename Pointer>
struct _pointer_element_type<Pointer, true> { typedef typename Pointer::element_type type; };

template <template <typename, typename...> class Pointer, typename T, typename... Args>
struct _pointer_element_type<Pointer<T, Args...>, false> { typedef T type; };
...
struct _pointer_difference_type { typedef void type; };

template <typename Pointer>
struct _pointer_difference_type<Pointer, true> { typedef typename Pointer::difference_type type; };
...
struct pointer_traits<T *> {
	...
	static pointer pointer_to(conditional_t<is_void_v<element_type>, void, element_type> &r) noexcept {
